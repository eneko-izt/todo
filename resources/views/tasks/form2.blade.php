<div class="bg-white shadow rounded-xl p-4 space-y-4">
    ...
    <div class="flex flex-col">
        <label for="text{{ $task->id }}" class="text-sm font-medium text-gray-700 mb-1">Text:</label>
    ...
    <!-- Column -->
    <div class="flex flex-col">
        <label for="column_id{{ $task->id }}" class="text-sm font-medium text-gray-700 mb-1">Column:</label>
    ...
    <!-- Tags -->
    <div class="flex flex-col">
        <label for="tags{{ $task->id }}[]" class="text-sm font-medium text-gray-700 mb-1">Tags:</label>
